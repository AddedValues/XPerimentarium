...
def plot_route(coordinates: List[Tuple[float, float]], dist: float = 1000, zoom_start: int = 15) -> folium.Map:
    """
    ...
    mymap = folium.Map(location=map_center, zoom_start=zoom_start, tiles="cartodbpositron")
